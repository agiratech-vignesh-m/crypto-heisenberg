...
const LoanDetails = () => {
    ...
    const loanRepay = async() => {
      let repay = await repayLoanSetup("metamask", walletData?.account, studentid, details?.monthlyInstallments);
    ...
    return (
        ...
        <Table sx={{ minWidth: 700}} aria-label="customized table">
          ...
          <TableBody>
              ...
              <StyledTableRow>
                ...
                <StyledTableCell align="right"> {details?.monthlyInstallments} </StyledTableCell>
      ...
      <Grid item md={6} >
          <TextField id="outlined-basic" variant="outlined" value={details?.monthlyInstallments} style={{padding:'5%', margin:'5%'}}/>
          </Grid>
      <Grid item md={12} >
